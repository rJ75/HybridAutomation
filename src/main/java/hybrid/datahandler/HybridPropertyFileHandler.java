...
public class HybridPropertyFileHandler {

	private Properties property = new Properties();
	private String propFileName = null;
	HybridPropertyFileHandler propertyHandler;
	

	public HybridPropertyFileHandler(String filename) {
	...
	public static HybridPropertyFileHandler getPropertyHandler(String filename) {
		HybridPropertyFileHandler propertyHandler = new HybridPropertyFileHandler(filename);
	...
	public String getProperty(String Key, String propFileName) {
		setPropertyFileName(propFileName);
